...
PREFERENCE_NORMALIZERS: dict[str, Callable[[Any], Any]] = {
    ...
    "delivery.failure_alerts_enabled": _normalize_bool,
    "delivery.failure_alert_channels": _normalize_channels,
    "delivery.failure_alert_cooldown_minutes": _normalize_positive_int,
